package bankapp.bankApplication.security;

import bankapp.bankApplication.filters.CustomAuthenticationFilter;
import bankapp.bankApplication.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                ...
                .requestMatchers(GET, "/userRegistration/users").hasAnyAuthority("ROLE_USER","ROLE_ADMIN")
                .requestMatchers(POST, "/userRegistration/users").hasAnyAuthority("ROLE_ADMIN")
